function varargout = Allman_TOJ_2AFC_Monitor_AS(varargin)
% ALLMAN_TOJ_2AFC_MONITOR_AS MATLAB code for Allman_TOJ_2AFC_Monitor_AS.fig
%
% DJS 7/2015

% Last Modified by GUIDE v2.5 11-Feb-2016 20:49:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Allman_TOJ_2AFC_Monitor_AS_OpeningFcn, ...
                   'gui_OutputFcn',  @Allman_TOJ_2AFC_Monitor_AS_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Allman_TOJ_2AFC_Monitor_AS is made visible.
function Allman_TOJ_2AFC_Monitor_AS_OpeningFcn(hObj, e, h, varargin)
...
function varargout = Allman_TOJ_2AFC_Monitor_AS_OutputFcn(hObj, e, h) 
...
% Trial Count
set(h.BoxLabel,'Title',['BOX: ',h.BOXID]);
set(h.TrialCount,'Title',['TRIALS: ',num2str(0)])
...
% Table Information --> Add additional information to the table
D = cell(ntrials,4);
D(:,1) = TRIALTYPE;
