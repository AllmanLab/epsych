...
% Last Modified by GUIDE v2.5 15-Jul-2015 14:46:48
...
% incuedelay
val{:} = SelectTrial(RUNTIME.TRIALS,'cue_delay~1');
set(h.INCueDelay,'String',sprintf('[%0.f %0.f]',val{1}(1),val{1}(2)));

% intimeout
val = SelectTrial(RUNTIME.TRIALS,'timeout_dur~1');
set(h.INTimeOut,'String',sprintf('%0.f',val));

% incuedelay
val = SelectTrial(RUNTIME.TRIALS,'*RewardRate~1');
...
% NEWCueDelay = sprintf('[%0.f %0.f]',NEWCueDelay(1),NEWCueDelay(2));
